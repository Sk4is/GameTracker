...
export default function OperatorsPage() {
  ...
  <div className="opsControlsCard">
    {/* Search */}
    <div className="opsSearchRow">
      <input
        className="opsSearch"
        value={q}
    ...
    {/* Sort + Tabs */}
    <div className="opsControlsRow">
      <div className="opsSortGroup">
        <select
      ...
      <div className="opsSegment">
        <button
          className={`opsSegBtn ${side === "all" ? "isActive" : ""}`}
          onClick={() => setSide("all")}
          type="button"
        >
          Todos
        ...
        <button
          className={`opsSegBtn ${side === "attacker" ? "isActive" : ""}`}
        ...
        <button
          className={`opsSegBtn ${side === "defender" ? "isActive" : ""}`}
...
>
  ...
  <div className="rolesBox rolesBox--def">
  ...
  <div className="rolesBox rolesBox--atk">
  ...
  <div className="rolesBox rolesBox--spec">
